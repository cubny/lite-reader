...
/*
   Script: Model.php
     Implementation of a model (record) to use easy CRUD function with 
...
/*
   ...
   Give some lazy method to use to Insert, update, delete Record in database
...
class Model
{
    ...
    final public static function query($sql, $values=false)
    {
        ...
        else return self::$__CONN__->query($sql);
    }
